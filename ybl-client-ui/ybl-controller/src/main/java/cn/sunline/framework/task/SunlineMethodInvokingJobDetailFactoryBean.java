 ...
 * @see #setConcurrent
 */
public class SunlineMethodInvokingJobDetailFactoryBean extends ArgumentConvertingMethodInvoker
	...
	static {
		try {
			jobDetailImplClass = ClassUtils.forName("org.quartz.impl.JobDetailImpl",
					SunlineMethodInvokingJobDetailFactoryBean.class.getClassLoader());
		}
	...
	private boolean concurrent = false;// 默认值修改成false
...
//		}
	...
	public Object getTargetObject() {
		...
		if(!(targetObject instanceof AbstractTask)) {
			throw new RuntimeException("targetObject must be extends cn.sunline.framework.task.AbstractTask.");
		}
		// end lixx
		return targetObject;
	}
	...
	/**
	 * 
	 * 扩展spring原生方法，使默认值为run
	 * 
	 */
	@Override
	public String getTargetMethod() {
		String targetMethod = super.getTargetMethod();
	...
	/**
	 * 
	 * 扩展spring原生类，增加targetObject判断，必须继承AbstractTask类，否则抛出异常
	 * @author andyLee
	 * @createDate 2017-05-09 11:50:00
	 */
	@Override
