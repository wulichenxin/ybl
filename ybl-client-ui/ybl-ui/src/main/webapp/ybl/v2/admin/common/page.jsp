...
function $GrxPage(){
    ...
    ha.push('<li><a onclick="goPage('+(_pageNumber -1)+')">上一页</a></li>');
    ...
    ha.push('<li><a onclick="goPage('+(_pageNumber+1)+')">下一页</a></li>');
...
function goPage(pageNumber){
	...
	$('#pageSize').val($("select[name='pageSize']").val());
