...
<title><spring:message code="sys.v2.client.account.audit"/>-<spring:message code="sys.v2.client.analysis"/></title>
...
// 		$("#common_upload_btn").val('');
		...
		var input4 = $("<input type='hidden' value='ybl_v2_accounts_receivable_analyze' name='attachmentList["+(table_length - 2)+"].type_'/>");
	...
	callback = function() {
		parent.parent.location.href="/accountsAffirmController/queryAnalyzeList.htm";
	}
})
</script>
</head>
<body>
		...
		<div class="v2_top_con">
			...
			<div class="v2_z_nav now">
				...
				<div class="v2_z_navbox">
					...
					<a class="w150 now" href="/accountsAffirmController/queryAnalyzeList.htm"><spring:message code="sys.v2.client.analysis"/></a>
	...
	<form action="/accountsAffirmController/auditAccount" id="submit" method="post">
		...
		<input type="hidden" name="status" value="analyze"/>	                                   <!-- 审核表status -->
		<div class="v2_vip_conbody">
			<div class="v2_path_no"><spring:message code="sys.v2.client.location"/>：
				...
				<spring:message code="sys.v2.client.analysis"/> >
				...
				<div class="v2_tab">
					...
					<div>
						<div class="v2_tab_con">
							...
							<div class="v2_text_box">
								<h1><spring:message code="sys.v2.client.analysis" /><!-- 尽调分析 --></h1>
								<ul>
									<li class="clear">
										<div class="v2_input_box"><span><spring:message code="sys.v2.client.analysis.result" /><!-- 尽调结果 -->：</span>
									...
									<li class="ww100">
										<div class="v2_input_box"><span><spring:message code="sys.v2.client.analysis.opinion" /><!-- 尽调意见 -->：</span><textarea class="v2_text_tea h100 w890" id="comment" name="comment"></textarea></div>
									</li>
									<li class="ww100">
										<div class="v2_input_box">
						   ...
						   <div class="v2_text_box">
							...
							<div class="v2_but_list">
								<c:if test="${maxAuditRecord.type_ == 'ybl_v2_accounts_receivable_audit' }">
									<c:if test="${maxAuditRecord.operation_ == 'authstr' && maxAuditRecord.status_ == 'analyze'}">
										<a class="bg_l" id="factor_analyze_accountAffirm_agree_audit_btn"><spring:message code="sys.v2.client.submit"/><!-- 提交 --></a>
