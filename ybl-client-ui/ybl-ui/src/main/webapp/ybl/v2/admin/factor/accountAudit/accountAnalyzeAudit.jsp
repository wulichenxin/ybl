...
<script type="text/javascript">
	$(function() {
		$("#factor_analyze_account_Manage_Query_btn").click(function() {
...
<body>
<form action="/accountsAffirmController/queryAnalyzeList.htm" id="pageForm" method="post">
	<div class="v2_top_bg v2_t_bg2 h410">
		<div class="v2_top_con">
			...
			<div class="v2_path"><spring:message code="sys.v2.client.location"/>：<spring:message code="sys.v2.client.account.audit"/> > <spring:message code="sys.v2.client.analysis"/><!-- 尽调分析 --></div>
			<!--搜索条件-->
			<div class="v2_seach_box">
				<ul>
					...
					<li class="w420"><label><spring:message code="sys.v2.client.contract.confrim.date"/><!-- 确认日期 -->:</label><span><input
					...
					<select class="v2_select w320" 
						...
						textField="value_" 
						isSelect="Y" defaultValue="${account.operation_ }">
					</select>
					</li>
					<li class="w420"><label><spring:message code="sys.v2.client.contract.apply.date"/><!-- 申请日期 -->:</label><span><input
					...
					<li><div class="v2_button_seach">
							<a id="factor_analyze_account_Manage_Query_btn"><spring:message code="sys.v2.client.query"/><!-- 查询 --></a>
						</div></li>
				...
				<div class="v2_table_con">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<th width="100"><spring:message code="sys.v2.client.contract.apply.date"/><!-- 申请时间 --></th>
							<th width="120"><spring:message code="sys.v2.client.contract.confrim.date"/><!-- 确认日期 --></th>
						...
						<c:forEach var="list" items="${list}" varStatus="index">
							<tr>
								...
								<td>
									<c:if test="${list.audit_status == 'analyze'}">
								...
								<td>
									<c:if test="${list.audit_status == 'analyze'}">
										<c:if test="${list.operation_ == 'authstr'}">
											<a class="lan" href="/accountsAffirmController/queryauditAnalyzeDetail.htm?id=${list.id_ }">
												<spring:message code="sys.v2.client.auditOperator"/><!-- 审核 -->
											</a>
										</c:if>
