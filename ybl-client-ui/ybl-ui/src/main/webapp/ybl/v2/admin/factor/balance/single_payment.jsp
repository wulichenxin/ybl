...
<title><spring:message code="sys.v2.client.single.payment" /></title>
<!-- 单笔回款 -->
...
<script language='javascript'
	src="${app.staticResourceUrl}/ybl/resources/v2/js/single_payment.js"></script>
...
<body>
	...
	<div class="v2_vip_conbody">
		<div class="v2_path_no">
			...
			>
			<spring:message code="sys.v2.client.single.payment" />
		</div>
		<div class="v2_box_border mt20">

			<div class="v2_tab_con">
				<div class="v2_text_box_g">
					<ul>
						...
						<li><span><spring:message
									code="sys.v2.client.plan.return.date" /> <!-- 计划回款日 -->：</span>
						<fmt:formatDate value="${repaymentRecord.repaymentDate}"
								pattern="yyyy-MM-dd" /></li>
						<li class="clear"><span><spring:message
									code="sys.v2.client.amountOfMoneyBack.pending" /> <!-- 待回款金额 -->：</span><b
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<th width="50"><spring:message code="sys.v2.client.no" />
											<!-- 序号 --></th>
										<th><spring:message code="sys.v2.client.return.date" />
											<!-- 回款日期 --></th>
										<th><spring:message
				...
				<div class="v2_text_box">
					<ul>
						<li><div class="v2_input_box">
								<span><spring:message
										code="sys.v2.client.amountOfMoneyBack" /> <!-- 回款金额 -->：</span><input id="amount"
									placeholder="" type="text" class="w300 v2_text fl validate[required,custom[number],min[0.01],minSize[1],maxSize[8]]" /><i>*</i>
							</div></li>
						<li class=" clear"><div class="v2_input_box">
								<span><spring:message code="sys.v2.client.return.date" />
									<!-- 回款日期 -->：</span>
								<div class="v2_date">
						...
						<li><div class="v2_input_box">
								<span><spring:message
										code="sys.v2.client.trade.stream.number" /> <!-- 交易流水号 -->：</span><input id="trxNumber"
									placeholder="" type="text" class="w300 v2_text validate[required]" /><i>*</i>
							</div></li>
						<li class="ww100 clear"><div class="v2_input_box">
								<span><spring:message code="sys.v2.client.remark" /> <!-- 备注 -->：</span>
								<textarea id="comment" class="v2_text_tea w890 h100" ></textarea>
							</div></li>
					</ul>
				</div>

				<div class="v2_but_list">
					<%-- <sun:button id="v2_single_repayment_save_and_add" tag='a' clazz="bg_l" i18nValue="sys.v2.client.saveAndAdd" /> --%>
					<c:if test="${ repaymentRecord.amount - repaymentRecord.actualAmount > 0}">
						<sun:button id="v2_single_repayment_save" tag='a' clazz="bg_l" i18nValue="sys.v2.client.save" />
					</c:if>
	...
	<!-- 其他参数 -->
	<input id="repaymentId" type="hidden" value="${repaymentRecord.id }"/>
	<input id="balanceId" type="hidden" value="${balance.id }"/>
