...
<title><spring:message code="sys.v2.client.account.audit"/>-<spring:message code="sys.v2.client.riskReAudit"/></title>
...
// 		$("#common_upload_btn").val('');
		...
		var input4 = $("<input type='hidden' value='ybl_v2_accounts_receivable_recheck' name='attachmentList["+(table_length - 2)+"].type_'/>");
	...
	callback = function() {
		parent.parent.location.href="/accountsAffirmController/queryRecheckList.htm";
	}
})
</script>
...
<body>
	...
	<form action="/accountsAffirmController/auditAccount" id="submit" method="post">
		...
		<input type="hidden" name="status" value="recheck"/>	                                   <!-- 审核表status -->
		<div class="v2_vip_conbody">
			<div class="v2_path_no"><spring:message code="sys.v2.client.location"/>:
				...
				<spring:message code="sys.v2.client.riskReAudit"/> > 
				...
				<div class="v2_tab">
					...
					<div>
						<div class="v2_tab_con">
							...
							<div class="v2_text_box">
								<h1><spring:message code="sys.v2.client.riskReAudit" /><!-- 风控复审 --></h1>
								<ul>
									<li class="clear">
										<div class="v2_input_box"><span><spring:message code="sys.v2.client.review.result" /><!-- 复审结果 -->：</span>
						   ...
						   <div class="v2_text_box">
							...
							<div class="v2_but_list">
								<c:if test="${maxAuditRecord.type_ == 'ybl_v2_accounts_receivable_audit' }">
									<c:if test="${maxAuditRecord.operation_ == 'authstr' && maxAuditRecord.status_ == 'recheck'}">
										<a class="bg_l" id="factor_recheck_accountAffirm_agree_audit_btn"><spring:message code="sys.v2.client.submit"/><!-- 提交 --></a>
