...
<body>
	<form action="/contract/coreReceivableInfoPage" id="pageForm" method="post">
	<div class="v2_top_bg v2_t_bg1 " style="height:410px;">
	...
	<div class="v2_seach_box">
		<ul>
			...
			<li class="ww28"><label><spring:message code="sys.v2.client.factor" />:</label><input type="text" name="enterpriseName" value="${receivable.enterpriseName }"/></li>
	        	...
	        	<table border="0" cellspacing="0" cellpadding="0" style="width:2000px;">
	              <tr>
	               <th width="50"><spring:message code="sys.v2.client.no" /></th>
	                ...
	                <th width="160"><spring:message code="sys.v2.client.factor" /></th>
