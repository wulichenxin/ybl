...
<div class="v2_about_box">
	<div class="v2_d_position"> <a href="/gatewayController/index.htm">首页</a> > <a href="/gatewayController/toAboutUs.htm">公告通知 </a> > ${currentNotice.title }</div>
	<div class="v2_news_con">
		<div class="v2_news_tittle">
			<h3>${currentNotice.title }</h3>
			<fmt:formatDate value="${currentNotice.releaseDate }" pattern="yyyy-MM-dd"/>
		</div>
		...
		<div class="v2_news_bottom">
			<div class="v2_news_prve">
				...
				<div class="v2_news_dxx">
					...
					<h5>上一篇</h5>
					<p><a href="/gatewayController/noticeDetail.htm/${prevNotice.id }">${prevNotice.title}</a></p>
					</c:if>
				</div>
			</div>
			<div class="v2_news_next">
				...
				<div class="v2_news_dxx fr">
					...
					<h5>下一篇</h5>
					<p><a href="/gatewayController/noticeDetail.htm/${nextNotice.id }">${nextNotice.title}</a></p>
					</c:if>
				</div>
			</div>
		</div>
