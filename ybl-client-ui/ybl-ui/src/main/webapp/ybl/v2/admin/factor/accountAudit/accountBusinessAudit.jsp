...
<script type="text/javascript">
	$(function() {
		$("#factor_business_account_Manage_Query_btn").click(function() {
...
<body>
<form action="/accountsAffirmController/queryBusinessList.htm" id="pageForm" method="post">
	<div class="v2_top_bg v2_t_bg2 h410">
		<div class="v2_top_con">
			...
			<div class="v2_path"><spring:message code="sys.v2.client.location"/>：<spring:message code="sys.v2.client.account.audit"/> > <spring:message code="sys.v2.client.businessHandling"/></div>
			<!--搜索条件-->
			<div class="v2_seach_box">
				<ul>
					...
					<li><div class="v2_button_seach">
							<a id="factor_business_account_Manage_Query_btn"><spring:message code="sys.v2.client.query"/><!-- 查询 --></a>
						</div></li>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<c:forEach var="list" items="${list}" varStatus="index">
							<tr>
								...
								<td>
									<c:if test="${list.audit_status == 'business'}">
								...
								<td>
									<c:if test="${list.audit_status == 'business'}">
										<c:if test="${list.operation_ == 'authstr'}">
										<a class="lan" href="/accountsAffirmController/queryBusinessDetail.htm?id=${list.id_ }">
