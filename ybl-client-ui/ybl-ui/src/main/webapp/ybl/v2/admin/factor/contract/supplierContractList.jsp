...
<body>
<form action="/contract/supplierContractPage" id="pageForm" method="post">
<div class="v2_top_bg">
	<div class="v2_top_con">
		...
		<div class="v2_seach_box">
			<ul>
				...
				<li class="ww28"><label><spring:message code="sys.v2.client.factor" />:</label><input type="text" name="enterpriseName" value="${contract.enterpriseName }" /></li>
			...
			<div class="v2_table_con">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td><a class="lan" href="/contract/contractDetails?contractId=${obj.id }"><spring:message code="sys.v2.client.detail" /></a></td>
					</tr>
					</c:forEach>
				</table>
			</div>
