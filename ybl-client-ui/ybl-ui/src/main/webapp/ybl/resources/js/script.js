...
function getjjrszModelByYear(year) {
	jjrmodelidlist = [ '1', '2' ];
	jjrmodeltimelist = [ '2015-08-30 00:00:00', '2015-08-31 00:00:00' ]; // 这里时间的格式为yyyy-MM-dd
																			// HH:mm:ss
...
function setRigth(year, yue, day) {
	...
	rigthdiv.style.marginRight = (w.offsetWidth * 0.7 + 4) + "px"; // 设置margin-left
	// 给p中添加span显示值
	...
	szrqselect.style.width = (withClass("aboluo-rightdiv").offsetWidth * 0.9)
			+ "px";
