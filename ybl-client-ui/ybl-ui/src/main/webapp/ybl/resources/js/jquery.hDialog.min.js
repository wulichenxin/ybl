    ...
    methods = {
        init: function (options) {
            ...
            if (o.closeHide != false) {
                $obj.stop().append('<a id="HCloseBtn" title="关闭" style="width:24px;height:24px;line-height:18px;display:inline-block;cursor:pointer;color:#fff;font-size:1.4em;text-align:center;position:absolute;top:8px;right:5px;"><span class="iconClose"></span></a>').css({
                    "position": "fixed",
