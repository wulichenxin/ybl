...
(function($) {
	...
	$.msgbox = function(o) {
		...
		opts.height            = o.height 		       || 600,                    // 提示框的高度
		opts.autoClose         = o.autoClose 	       || 0;                      // 自动关闭的时间, 0则不会自动关闭
		opts.title 			       = o.title 		         || '提示',                 // 提示框标题
		opts.wrapperClass	     = o.wrapperClass      || 'v2_msgbox_wrapper';       // 提示框外框class
		opts.titleClass 	     = o.titleClass 	     || 'v2_msgbox_title';         // 提示框标题class
		opts.closeClass        = o.closeClass        || 'v2_msgbox_close';         // 提示框关闭按钮class
		opts.titleWrapperClass = o.titleWrapperClass || 'v2_msgbox_title_wrapper'; // 提示框标题行class
		opts.mainClass 		     = o.mainClass   	     || 'v2_msgbox_main';          // 内容框class
		opts.bgClass 		       = o.bgClass 	         || 'v2_msgbox_bg';            // 背景层class
		opts.buttonClass	     = o.buttonClass       || 'v2_msgbox_button';        // 内容框中button的class
		opts.inputboxClass     = o.inputboxClass     || 'v2_msgbox_inputbox';      // 内容框中input box的class
		...
		var $titleWrapper = $('<ul><li>提示</li><li></li></ul>')
