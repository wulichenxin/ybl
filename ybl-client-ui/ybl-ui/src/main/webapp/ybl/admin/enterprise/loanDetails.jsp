...
<body>
	...
	<!--top end -->
	<div class="path"><spring:message code="sys.client.location"/><spring:message code="sys.client.location"/>-><spring:message code="sys.client.voucher.manage"/> -> <spring:message code="sys.client.loan.sure"/>-> <spring:message code="sys.client.loanDetail"/><!-- 贷款详情 --></div>
	<div class="vip_conbody body_cbox">
		<div class="tabnav">
			<div class="v_tittle">
				<h1>
					<i class="v_tittle_2"></i><spring:message code="sys.client.loanDetail"/>
				</h1>
			</div>
			<div class="rzsq_box">
				...
				<div class="rzzt">
					<ul>
						   ...
						   <div class="input_box">
								...
								<div>
									<spring:message code="sys.client.yearRate"/><!-- 年利率 --><input placeholder="10" type="text"
										class="text w50 mr10 ml10" value="${financeApply.rate_}" readonly="readonly"/>%
								</div>
							</div>
						</li>
						<li class="clear w472"><div class="input_box">
								...
								<div>
									<spring:message code="sys.client.dailyInterest"/><!-- 日利率 --><input placeholder="10" type="text"  
										class="text w50 mr10 ml10" value="${financeApply.overdue_rate}" readonly="readonly"/>%
								</div>
							</div></li>
						<li class="w472"><div class="input_box">
								...
								<div>
									<spring:message code="sys.client.yearRate"/><!-- 年利率 --><input placeholder="10" type="text"
										class="text w50 mr10 ml10" value="${financeApply.manage_rate}" readonly="readonly"/>%
								</div>
							</div></li>
						<li class="w472"><div class="input_box">
								...
								<div>
									<spring:message code="sys.client.dailyInterest"/><!-- 日利率 --><input placeholder="10" type="text"
										class="text w50 mr10 ml10" value="${financeApply.penalty_rate}" readonly="readonly"/>%
								</div>
							</div></li>
						<li class="w472"><div class="input_box"> 
								<span><spring:message code="sys.client.financingProportion"/><!-- 融资比例 -->：</span><input placeholder="20" type="text"
									class="text w50 mr10" value="${financeApply.finance_ratio}" readonly="readonly"/>%
							</div></li>
					</ul>
				</div>
			</div>
			...
			<%-- <c:if test="${ product.status_ =='auditing'}">
				<a href="javascript:voucherComfirm();"><spring:message code="sys.client.auditOperator"/><!-- 预览 --></a>
				<input id="financeIds" type="hidden" value="${ids}"/> 
			</c:if> --%>
