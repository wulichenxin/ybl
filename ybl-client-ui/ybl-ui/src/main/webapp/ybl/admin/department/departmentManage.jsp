...
<body>
	...
	<!--top end -->
	<div class="path">当前位置->用户管理 -> 部门管理</div>
	<div class="cont">	
	<!--lefttree-->
	<ul id="treeDemo" class="ztree" style="height: 450px;position: absolute;top: 235px;left: 90px;">
    </ul>
	<div class="left_box">
    	<div class="tree">
        <div class="xtree_tittle">
        	<span class="tree_zl_ico tree_title_span"></span>
        	<span class="tittle bottom_line" id="txt_enterprise">${enterpriseName}</span>
        	<div class="clear"></div>
            </div>
        </div>
    </div>
