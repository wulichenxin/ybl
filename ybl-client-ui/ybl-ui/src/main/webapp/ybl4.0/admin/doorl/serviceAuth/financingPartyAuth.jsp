...
<html>
	...
	<body>
		<%-- <div class="Bread-nav">
			<div ><img class="mr10" src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />业务认证<span class="mr10 ml10">-</span>融资方业务认证</div>
		</div> --%>
			...
			<div class="pd20">
						<div class="tabD">
							<table>
								...
								<tr>
									<td>5</td>
									<td class="maxwidth200"><span style="color:red">*</span>公司章程</td>
								...
								<tr>
									<td>7</td>
									<td class="maxwidth200"><span style="color:red">*</span>企业信用报告</td>
									<td class="maxwidth200" id="enterprise_credit_repor_td">原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="javascript:;" id='enterprise_credit_repor' utype="18" uname="企业信用报告" class="btn-modify">上传</a>
										<%-- 附件对象隐藏域  --%>  
										<div id="enterprise_credit_repor_div"></div>
									</td>
								</tr>
								<tr>
									<td>8</td>
									<td class="maxwidth200">公司股东介绍（包含实际控制人、股东关系、股权结构）</td>
									<td class="maxwidth200" id="company_shareholders_introduction_td">原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="javascript:;" id='company_shareholders_introduction' utype="21" uname="公司股东介绍（包含实际控制人、股东关系、股权结构）" class="btn-modify">上传</a>
										<%-- 附件对象隐藏域  --%>  
										<div id="company_shareholders_introduction_div"></div>
									</td>
								</tr>
								<tr>
									<td>9</td>
									<td class="maxwidth200">公司高管介绍（包含董事长、总经理、财务总监等）</td>
									<td class="maxwidth200" id="company_executives_introduction_td">原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="javascript:;" id='company_executives_introduction' utype="22" uname="公司高管介绍（包含董事长、总经理、财务总监等）" class="btn-modify">上传</a>
										<%-- 附件对象隐藏域  --%>  
										<div id="company_executives_introduction_div"></div>
									</td>
								</tr>
								<tr>
									<td>10</td>
									<td class="maxwidth200">公司业务介绍（说明公司的主要经营业务、营收情况等）</td>
									<td class="maxwidth200" id='company_business_introduction_td'>原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="javascript:;" id='company_business_introduction' utype="23" uname="公司业务介绍（说明公司的主要经营业务、营收情况等）" class="btn-modify">上传</a>
										<%-- 附件对象隐藏域  --%>  
										<div id="company_business_introduction_div"></div>
									</td>
								</tr>
								</c:if>
