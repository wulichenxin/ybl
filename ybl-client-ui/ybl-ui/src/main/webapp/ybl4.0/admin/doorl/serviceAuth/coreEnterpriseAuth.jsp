...
<html>
	...
	<body>
		<%-- <div class="Bread-nav">
			<div ><img class="mr10" src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />业务认证<span class="mr10 ml10">-</span>核心企业业务认证</div>
		</div> --%>
		...
		<!-- attchment start -->
						...
						<div class="tabD">
							<table>
								...
								<tr>
									...
									<td id="business_license_td" class="maxwidth200" >原件、复印件、加盖公章、提供扫描件</td>
								...
								<tr>
									...
									<td id="license_account_td" class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
								...
								<tr>
									...
									<td id="credit_code_td" class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
								...
								<tr>
									...
									<td id="legal_representative_identity_card_td" class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
		    ...
		    <div class="btn2 clearfix ">
				...
				<a href="javascript:;" class="btn-add btn-center" id="go_to_back">返回</a>
				</c:if>
			</div>
