...
<html>
	...
	<body>
		<form action="<%=basePath%>factorLoanAuditController/loanAudit/payableElementsAudit.htm" id="pageForm" method="post">
		...
		<script>
			...
			$(function(){
				...
				$("#commit").click(function(){
					...
					$.ajax({
						type : 'post',
						url : '/factorLoanAuditController/loanAudit/payableElementsAudit',
						data : formParam,
						dataType : 'json',
						success : function(data){
							if (data.responseTypeCode == 'success') {
