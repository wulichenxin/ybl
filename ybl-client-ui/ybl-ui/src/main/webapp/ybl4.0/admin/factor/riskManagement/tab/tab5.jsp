	...
	<!--top start -->
		...
		<div class="w1200 ybl-info box box1">
			<div class="ground-form mb20">
				<div class="form-grou mr40"><label>融资订单号：</label><input class="content-form" /></div>
				<div class="form-grou"><label>申请单位：</label><input class="content-form2" /></div>
				<div class="form-grou"><label class="label-long">竞标截止时间：</label><input class="content-form2" /></div>
			</div>
			
			<div class="ground-form mb20">
				<div class="form-grou mr40"><label>融资方式：</label><select class="content-form"><option>待提交</option></select></div>
				<div class="form-grou"><label>资方名称：</label><input class="content-form2" /><img src="images/mbl_search_icon.png" class="timeimg" /></div><a class="ml10 mr40" href="javascript:;"><img src="images/mbl_add_icon.png" /></a>
			</div>
			<div class="ground-form">
				<div class="form-grou"><label>资方名称：</label><input class="content-form" /></div>
			</div>
								...
								<table>
									...
									<c:forEach items="${stockHolderList}" var="obj" varStatus="index">
										<tr>
											...
											<td><input class="tdinput" type="text" value="<fmt:formatNumber value="${obj.investment_ratio*100}" pattern="0.00"/>"/></td>
											<td><input class="tdinput" type="text" value="${obj.investment_mode }"/></td>
											<td><input class="tdinput" type="text" value="${obj.legal_name }"/></td>
											<td><input class="tdinput" type="text" value="<fmt:formatNumber value="${obj.received_amount}" pattern="0.00"/>"/></td>
											<td><input class="tdinput" type="text" value="<fmt:formatNumber value="${obj.received_amount}" pattern="0.00"/>"/></td>
											<td><input class="tdinput" type="text" value="<fmt:formatDate value="${obj.register_date }" pattern="yyyy-MM-dd" />"/></td>
										</tr>
									</c:forEach>
								</table>
						</div>
				...
				<div class="chebox chebox4">
					...
					<div class="grounpinfo">
						<div class="ground-form mb20">
							...
							<div class="form-grou mr50"><label>融资金额：</label><input class="content-form" value="<fmt:formatNumber value="${financing.financingAmount}" pattern="0.00"/>"/></div>
						</div>
						<div class="ground-form">
							<div class="form-grou mr50"><label>融资期限：</label><input class="content-form" value="<fmt:formatDate value="${financing.financingTerm }" pattern="yyyy-MM-dd" />"/></div>
						...
						<div class="tabD">
							<table>
								...
								<tr>
									...
									<td><a href="javascript:;">融资需求表.pdf</a></td>
									<td><a href="javascript:;" class="btn-modify mr10">上传</a><a href="javascript:;" class="btn-supplement">下载</a></td>
								</tr>
								<tr>
									<td>2</td>
									<td>营业执照(三证合一)</td>
