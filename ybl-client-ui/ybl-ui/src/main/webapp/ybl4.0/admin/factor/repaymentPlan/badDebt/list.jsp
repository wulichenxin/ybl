...
<html>
	...
	<body>
		<div class="Bread-nav">
			<div class="w1200"><img class="mr10" src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />坏账管理</div>
		</div>
		<div class="w1200 mt40">
			<form action="/factorRepaymentPlanController/badDept/list.htm?flag=1" id="pageForm" method="post">
				<div class="ybl-info">
					...
					<div class="ground-form mb20">
						...
						<div class="form-grou"><label>还款状态：</label>
							<select class="content-form" name="">
								<option value="5">坏账</option>
							</select>
						</div>
					</div>
					<div class="ground-form mb20">
							...
							<table>
								...
								<c:forEach items="${list}" var="obj" varStatus="index">
					              	<tr>
										...
										<td><c:if test="${obj.repaymentStatus eq 5}">坏账</c:if></td>
										...
										<td>
											<a href="/factorRepaymentPlanController/agencyApply.htm" class="btn-modify mr10 tip" onclick="">申请代办</a>
										</td>
									</tr>
				              </c:forEach>
							</table>
