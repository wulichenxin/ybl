...
<html>
	...
	<body>
		<div class="Bread-nav">
			<div class="w1200"><img class="mr10" src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />放款申请审核</div>
		</div>
		<form action="<%=basePath%>factorLoanAuditController/loanAudit/loanAuditList.htm" id="pageForm" method="post">
			<div class="w1200 ybl-info">
				...
				<div class="ground-form mb20">
					<div class="form-grou mr40">
						...
						<input class="content-form" name="orderNo" value="${factorLoanAuditVo.orderNo }"/>
					</div>
					<div class="form-grou mr40">
						<label class="label-long">关联主合同号：</label>
						<input class="content-form" name="financingOrderNumber" value="${factorLoanAuditVo.financingOrderNumber }" />
					</div>
					<div class="form-grou">
				...
				<div class="ground-form mb20">
					<div class="form-grou">
						...
						<input id="beginDate" class="content-form" name="startApplyDate" value="${factorLoanAuditVo.startApplyDate }"/><img class="timeimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/cal_icon.png" />
					</div>
					<span class="mr10 ml10">-</span>
					<div class="form-grou mr40">
						<input id="endDate" class="content-form" name="endApplyDate" value="${factorLoanAuditVo.endApplyDate }"/><img class="timeimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/cal_icon.png" />
					</div>
				</div>
			</div>
					...
					<table>
						...
						<c:forEach items="${list}" var="obj" varStatus="index">
			              	<tr>
								...
								<td><a href="<%=basePath%>factorLoanAuditController/${obj.id }/view.htm" class="btn-modify mr10">审核</a></td>
							</tr>
		              </c:forEach>
					</table>
				</div>
		...
		<script type="text/javascript">
			...
			$(".subView").click(function(){
				...
				param={"id":lid,"url":"/factorLoanAuditController/loanAudit/loanAuditList.htm"};
				httpPost('/loanApplyCommonApi/selectChildrenDetail.htm',param);
			})
			/* $(".view").click(function(){
				var fid=$(this).attr("fid");
				var status=$(this).attr("status");
				param={"id":fid,"statue":status,"url":"/factorLoanAuditController/loanAudit/loanAuditList.htm"};
