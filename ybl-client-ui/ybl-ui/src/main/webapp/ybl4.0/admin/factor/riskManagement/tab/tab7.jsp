...
<!--top start -->
		...
		<div class="w1200 clearfix border-b">
			<ul class="clearfix formul">
				<li class="formli form_cur">平台复审</li>
			</ul>
		</div>
		<div class="w1200 ybl-info box box1">
			...
			<div class="process">
				...
				<ul class="clearfix proul clearfix">
					<li class="prolist pro_cur">平台复审<img class="pro-img-1" src="images/proPoint_icon.png" /><img class="pro-img-2" src="images/line_img_choose.png" /></li>
			...
			<div class="chebox chebox1">
				...
				<p class="protitle"><span></span>请选择平台复审结果</p>
				<div class="pd20">
				  <div> <label>复审结果：</label><input class="content-form" value="${records.audit_result}"/></div>
