	...
	<form action="<%=basePath%>factorLoanAuditController/loanAudit/receivableElementsAudit.htm" id="pageForm" method="post">
		...
		<div class="w1200">
			...
			<div class="grounpinfo">
				...
				<div class="ground-form mb20">
					<div class="form-grou mr50">
						...
						<input class="content-form2 validate[required]" name="creditor" value="${vo.creditor}" />
					</div>
					<div class="form-grou mr50">
						<label><a style = "color:red">*</a>买方名称：</label> 
						<input class="content-form2 validate[required]" name="debtor" value="${vo.debtor }" />
					</div>
					<div class="form-grou">
				...
				<div class="ground-form mb20">
					...
					<div class="form-grou mr50">
						...
						<input class="content-form2 validate[required,minSize[1],maxSize[28],min[0.01],max[100],custom[number]]" name="fee" value="${vo.fee }" /><span class="timeimg sffs-sp">%</span>
					</div> --%>
					<div class="form-grou mr50">
						<label><a style = "color:red">*</a>收费方式：</label>
						<select class="content-form2 sffs" name="feeMode" id="feeMode">
			...
			<div class="process">
				...
				<div class="pd20">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注：
					<textarea class="protext" name="remark" value="${vo.remark }"></textarea>
				</div>
				...
				<div class="shenmin">
					<input id="check" type="checkbox" />申明：以上填报内容及报送的资料属实，如有虚假或隐瞒，产生的任何责任和后果，本单位和法定代表承担一切法律责任。
				</div>
	...
	<script>
		...
		$(function() {
			...
			$("#commit").click(function(){//表单数据校验
				...
				$.ajax({
					type : 'post',
					url : '/factorLoanAuditController/loanAudit/receivableElementsAudit',
					data : formParam,
					dataType : 'json',
					success : function(data){
						if (data.responseTypeCode == 'success') {
