	...
	/* 	//通过比对状态，给tab页签加载样式
		...
		<div class="w1200">
			<ul class="clearfix iconul">
				...
				<c:choose>
						<c:when test="${statue >2}">clickTrue="clickTrue"</c:when>
				...
				<c:choose>
						<c:when test="${(statue >3 and statue!=10 and statue!=11) or (statue >3 and statue==10 and statue!=11)}">clickTrue="clickTrue"</c:when>
						<c:otherwise>clickTrue="clickFalse"</c:otherwise>
				</c:choose>
