			...
			<div class="w1200">
				...
				<div class="ground-form mb20">
					<div class="form-grou mr50">
						...
						<input placeholder="票据持有人" class="content-form2 validate[required]" name="billHolder" value="${vo.billHolder }"/>
					</div>
					<div class="form-grou mr50">
						<label><a style = "color:red">*</a>票据承兑人：</label>
						<input placeholder="票据承兑人" class="content-form2 validate[required]" name="billAcceptor" value="${vo.billAcceptor }"/>
					</div>
					<div class="form-grou">
						<label class="w140"><a style = "color:red">*</a>基础合同及编号：</label>
						<input placeholder="基础合同及编号" class="content-form2 validate[required]" name="baseContractNo" value="${vo.baseContractNo}"/>
					</div>
				</div>
				<div class="ground-form mb20">
					<div class="form-grou mr50">
				...
				<div class="ground-form mb20">
					...
					<div class="ground-form mb20">
						<div class="form-grou mr50">
							...
							<select class="content-form2" name="transactionMode" id="transactionMode" disabled="true">
								<option value="">请选择</option>
						...
						<div class="form-grou">
							...
							<select class="content-form2" name="repaymentMode" id="repaymentMode" disabled="true">
								<option value="">请选择</option>
				...
				<!-- <div class="btn3 clearfix mb80"> -->
					<a href="#" id="btn-2" class="btn-add btn-center">下一页</a>
