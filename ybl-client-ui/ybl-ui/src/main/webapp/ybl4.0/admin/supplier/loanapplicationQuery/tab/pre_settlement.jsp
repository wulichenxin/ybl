...
<html>
	...
	<form action="/factorLoanManagementController/loanBatchPending/list.htm" id="subPageForm" method="post">
		<div>
				<div class="pd20 mt40">
				<p class="protitle"><span>收款确认</span></p>
				<div class="pd20 mt40">
			...
			<p class="protitle"><span>确认收到融资款</span></p>
			<div class="ground-form mb20">
					<div class="form-grou mr40"><label class="label-long2">备注：</label><textarea class="protext w688" name="remark">${attachmentConfirm.remark}</textarea></div>
				</div>
				<div class="ground-form mb20">
					<div class="form-grou"><label class="label-long2">支付凭证：</label></label></div>
					<c:if test="${attachmentConfirm.id>0 }">
								<div class="pd20">
									<div id='licensePhoto'>
										<a href="/fileDownloadController/downloadftp?id=${attachmentConfirm.id }" ><img class="uploadimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/pro/dczc_addDaf_img.png" /></a>
									</div>
									<div id='licensePhoto_div'></div>
								</div>
						</c:if>
