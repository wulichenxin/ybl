...
<body>
	...
	<form action="/loanapplicationcontroller/list.htm" id="pageForm"
		method="post">
						...
						<c:forEach items="${page.records}" var="entity" varStatus="status">
							<tr>
								<td class="toggletr" uid="${entity.financing_apply_id}"
									pid="${entity.id}">${status.count} <c:if test="${entity.count ne 0}"><img alt="" id="imgs"
									src="${app.staticResourceUrl}/ybl4.0/resources/images/upList_icon.png"></c:if></td>
