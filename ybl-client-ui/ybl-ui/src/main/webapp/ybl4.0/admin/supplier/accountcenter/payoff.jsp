...
<head>
	...
	<body>
		...
		<!--top end -->
		<div class="Bread-nav">
			<div><img class="mr10" src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />已还清项目</div>
		</div>
		<form action="/supplierAccountCenterController/supplierpayoff.htm" id="pageForm" method="post">
			<div class="ybl-info">
				<div class="ground-form mb20">
					...
					<div class="form-grou">
						...
						<select class="content-form" name="repaymentStatus"><option value="3">完成</option></select>
					</div>
				</div>
							...
							<c:forEach items="${page.records}" var="obj" varStatus="index">
								...
								<td>
									...
									<%-- <a href="<%=basePath%>/supplierAccountCenterController/labelsPage?pageFlag=1&financingAmount=${obj.financingAmount}&
										assetsType=${obj.assetsType }&financingName=${obj.financingName}&orderNo=${obj.orderNo}" class="btn-supplement">查看</a> --%>
								</td>
							</tr>
			              </c:forEach>
						</table> 
