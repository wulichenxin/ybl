...
<body>
	...
	<div class="Bread-nav">
		<div class="w1200">
			<img class="mr10"
				src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />逾期还款
		</div>
	</div>
			...
			<div class="ground-form mb20">
				...
				<!-- <div class="form-grou mr40">
					<label>还款状态：</label><select class="content-form"
						name="repaymentStatus"><option value="">全部</option>
						<option value="1">待还款</option>
						<option value="2">待确认</option>
					</select>
				</div> -->
				<div class="form-grou"><label class="label-long">还款时间：</label><input id="startDate" class="content-form" name="startDate" value="${startDate}"/><img class="timeimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/cal_icon.png" /></div>
				<span class="mr10 ml10">-</span>
				<div class="form-grou mr40"><input id="endDate" class="content-form" name="endDate" value="${endDate}"/><img class="timeimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/cal_icon.png" />
				</div>
					...
					<table style="width: 2200px">
						...
						<c:forEach items="${list}" var="obj" varStatus="index">
							<tr>
								...
								<td><fmt:formatNumber value="${obj.overdueFee}"
