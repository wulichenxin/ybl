	...
	<form id="pageForm">
		...
		<div class="Bread-nav">
			<div class="w1200">
				...
				<span class="mr10 ml10">-</span>放款申请<span class="mr10 ml10">-</span>
				<c:if test="${operType == 'insert' }">新增</c:if>
				<c:if test="${operType == 'update' }">修改</c:if>
		...
		<div class="w1200 ybl-info box box1">
			<div class="ground-form mb20">
				<div class="form-grou mr40"><label class="label-long">放款申请单号：</label><input class="content-form" name="orderNo" value="${loanApplyVO.orderNo}" readonly/></div>
				...
				<div class="form-grou"><label>申请单位：</label><input class="content-form2" name="enterpriseName" <c:if test="${operType eq 'insert' }">value="${businessAuth.enterpriseName }"</c:if><c:if test="${operType ne 'insert' }">value="${loanApplyVO.enterpriseName }"</c:if> readonly/></div>
			</div>
			
			<div class="ground-form mb20">
				<div class="form-grou mr40"><label class="label-long">融资主合同号：</label><input class="content-form" name="masterContractNo" <c:if test="${operType eq 'insert' }">value="${subFinancingApply.order_no }"</c:if><c:if test="${operType ne 'insert' }">value="${loanApplyVO.masterContractNo }"</c:if> readonly/></div>
			...
			<div class="chebox chebox1">
				...
				<div class="grounpinfo">
					...
					<div class="ground-form mb20">
						...
						<div class="form-grou mr50"><label><i class="red-color-font">*</i>融资期限：</label><input class="content-form validate[maxSize[20],custom[integer],min[0]]" name="financingTerm" value="${loanApplyVO.financingTerm }" /><span class="timeimg">天</span></div>
					...
					<div class="scrollbox">
						<table id="receivableTb">
							...
							<tr class="addReceivable <c:if test="${not empty receivableList[0].pid and receivableList[0].pid ne 0 }">chkReceivableTr</c:if>" 
								...
								<td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" <c:if test="${not empty receivableList[0].pid and receivableList[0].pid ne 0 }">readonly style="color:#666"</c:if> value="${receivableList[0].orderNumber}" name="receivableList[0].orderNumber"/></td>
							...
							<c:if test="${operType ne 'insert' }">
								<c:forEach items="${receivableList}" begin="1" varStatus="index" var="obj">
									<tr class="addReceivable <c:if test="${not empty obj.pid and obj.pid ne 0 }">chkReceivableTr</c:if>" 
										...
										<td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" <c:if test="${not empty obj.pid and obj.pid ne 0 }">readonly style="color:#666"</c:if> value="${obj.orderNumber }" name="receivableList[${index.count }].orderNumber"/></td>
					...
					<div class="scrollbox">
						<table id="repayableTb">
							...
							<tr class="addRepayable <c:if test="${not empty repayableList[0].pid and repayableList[0].pid ne 0 }">chkRepayableTr</c:if>" 
								...
								<td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" <c:if test="${not empty repayableList[0].pid and repayableList[0].pid ne 0 }">readonly style="color:#666"</c:if> value="${repayableList[0].orderNumber}" name="repayableList[0].orderNumber"/></td>
							...
							<c:if test="${operType ne 'insert' }">
								<c:forEach items="${repayableList}" begin="1" varStatus="index" var="obj">
									<tr class="addRepayable <c:if test="${not empty obj.pid and obj.pid ne 0 }">chkRepayableTr</c:if>" 
										...
										<td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" <c:if test="${not empty obj.pid and obj.pid ne 0 }">readonly style="color:#666"</c:if> type="text" value="${obj.orderNumber }" name="repayableList[${index.count }].orderNumber"/></td>
					...
					<div class="scrollbox">
						<table id="billTb">
							...
							<tr class="addBill <c:if test="${not empty billList[0].pid and billList[0].pid ne 0 }">chkBillTr</c:if>" 
								...
								<td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" <c:if test="${not empty billList[0].pid and billList[0].pid ne 0 }">readonly style="color:#666"</c:if> value="${billList[0].orderNumber}" name="billList[0].orderNumber"/></td>
							...
							<c:if test="${operType ne 'insert' }">
								<c:forEach items="${billList}" begin="1" varStatus="index" var="obj">
                                 ...
                                 <c:if test="${not empty obj.pid and obj.pid ne 0 }">uid="${obj.pid }"</c:if>>
										...
										<td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" <c:if test="${not empty obj.pid and obj.pid ne 0 }">readonly style="color:#666"</c:if> value="${obj.orderNumber }" name="billList[${index.count }].orderNumber"/></td>
						...
						<div class="form-grou">
							<c:forEach items="${assetList}" varStatus="uindex" var="obj">
								<div class="wenjian"><c:if test="${operType ne 'query'}"><img uid="${obj.id}" class="delimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/pro/del_icon.png" /></c:if><img width="130" src="${app.staticResourceUrl}/ybl4.0/resources/images/pro/dczc_addDaf_img.png" />
									...
									<p><a class="filemaxwidth" href="${obj.url }" title="${obj.oldName }" target="_blank"  download="${obj.oldName }">${obj.oldName }</a></p>
								</div>
							</c:forEach>
						...
						<div class="tabD">
							<table>
								...
								<tr>
									...
									<td class="maxwidth200"><a href="${file41.url }" title="${file41.oldName }" target="_blank"  download="${file41.oldName }" id="file41_a">${file41.oldName }</a></td>
								...
								<tr>
									...
									<td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="${file42.url }" title="${file42.oldName }" target="_blank"  download="${file42.oldName }" id="file42_a">${file42.oldName }</a></td>
									<c:if test="${operType ne 'query'}"><td>
								...
								<tr>
									...
									<td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="${file43.url }" title="${file43.oldName }" target="_blank"  download="${file43.oldName }" id="file43_a">${file43.oldName }</a></td>
									<c:if test="${operType ne 'query'}"><td>
								...
								<tr>
									...
									<td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
									<td class="maxwidth200"><a href="${file44.url }" title="${file44.oldName }" target="_blank"  download="${file44.oldName }" id="file44_a">${file44.oldName }</a></td>
									<c:if test="${operType ne 'query'}"><td>
		...
		<script>
			...
			uploadAttachmentCallback = function(obj) {
				...
				htmlStr += '<p><a class="filemaxwidth" href="'+attachment.url_+'" title="'+attachment.old_name+'" target="_blank" download="'+attachment.old_name+'">'+attachment.old_name+'</a></p>';
				htmlStr += '</div>';
