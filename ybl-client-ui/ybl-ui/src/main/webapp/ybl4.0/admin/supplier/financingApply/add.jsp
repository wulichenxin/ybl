...
<html>
    ...
    <form id="pageForm">
        ...
        <div class="Bread-nav">
            <div class="w1200">
                <img class="mr10" src="${app.staticResourceUrl}/ybl4.0/resources/images/rzf_bre_icon.png" />业务办理
                <span class="mr10 ml10">-</span><c:if test="${financingApply.factoringMode == 1 }">明保理业务</c:if><c:if test="${financingApply.factoringMode == 2 }">暗保理业务</c:if>
                <span class="mr10 ml10">-</span><c:if test="${operType == 'insert' }">新增</c:if><c:if test="${operType == 'update' }">修改</c:if><c:if test="${operType == 'query' }">查看</c:if>
            </div>
        </div>
        ...
        <div class="w1200 ybl-info box box1">
            <div class="ground-form mb20">
                ...
                <div class="form-grou mr40"><label class="label-long">申请单位：</label><input class="content-form2" name="enterpriseName" <c:if test="${operType ne 'insert' }">value="${financingApply.enterpriseName }"</c:if>
                        <c:if test="${operType == 'insert' }">value="${businessAuth.enterpriseName }"</c:if> readonly/>
                </div><div class="form-grou">
                <label class="label-long"><i class="red-color-font">*</i>融资方式：</label><select id="financingMode" name="financingMode" class="content-form2">
                ...
                <div class="chebox chebox1">
                    ...
                    <div class="grounpinfo">
                        <div class="ground-form mb20">
                            ...
                            <div class="form-grou mr50"><label>性别：</label><input class="content-form2" id="controllerGender" 
                                <c:if test="${businessAuth.controllerGender eq 1 }">value="男"</c:if><c:if test="${businessAuth.controllerGender eq 2 }">value="女"</c:if> disabled="disabled"/></div>
                    ...
                    <div class="grounpinfo">
                        <div class="ground-form mb20">
                            ...
                            <div class="form-grou mr50"><label>性别：</label><input class="content-form2" id="legalGender" 
                                <c:if test="${businessAuth.legalGender eq 1 }">value="男"</c:if><c:if test="${businessAuth.legalGender eq 2 }">value="女"</c:if> disabled="disabled"/></div>
                        ...
                        <div class="ground-form mb20">
                            <div class="form-grou mr50"><label>身份证号码：</label><input class="content-form2" id="legalCardId" value="${businessAuth.legalCardId }" disabled="disabled"/></div>
                    ...
                    <div class="tabD mt30">
                        <table id="enterpriseLoanTb">
                            ...
                            <tr class="addEnterpriseLoan" id="enterpriseLoanFirst">
                                ...
                                <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" name="enterpriseLoanList[0].term"/></td>
                    ...
                    <div class="tabD mt30">
                        <table id="personDebtTb">
                            ...
                            <tr class="addPersonDebt" id="personDebtFirst">
                                ...
                                <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" name="personDebtList[0].term"/></td>
                    ...
                    <div class="tabD mt30">
                        <table id="guaranteeTb">
                            ...
                            <tr class="addGuarantee" id="guaranteeFirst">
                                ...
                                <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" name="guaranteeList[0].term"/></td>
            ...
            <div class="chebox chebox4">
                ...
                <div class="grounpinfo">
                    <div class="ground-form mb20">
                        ...
                        <div class="form-grou mr50"><label><i class="red-color-font">*</i>融资金额：</label><input class="content-form validate[maxSize[20],custom[number],min[0]]" name="financingAmount" value="<fmt:formatNumber value="${financingApply.financingAmount }" pattern="##0.##" maxFractionDigits="2"/>"/><span class="timeimg">元</span></div>
                    </div>
                    <div class="ground-form">
                        <div class="form-grou mr50"><label><i class="red-color-font">*</i>融资期限：</label><input class="content-form validate[maxSize[20],custom[integer],min[0]]" name="financingTerm" value="${financingApply.financingTerm }"/><span class="timeimg">天</span></div>
                        <div class="form-grou mr50"><label><i class="red-color-font">*</i>融资利率：</label><input class="content-form validate[maxSize[20],custom[number],min[0],max[100]]" name="financingRate" value="<fmt:formatNumber value="${financingApply.financingRate }" pattern="##0.####" maxFractionDigits="4"/>" /><span class="timeimg">%</span></div>
                    </div>
                </div>
                ...
                <div class="grounpinfo">
                    <div class="ground-form mb20">
                        <div class="form-grou mr50">
                            ...
                            <select class="content-form sele" id="assetsType" name="assetsType" >
                    ...
                    <div class="scrollbox">
                        <table id="receivableTb">
                            ...
                            <tr class="addReceivable" style="border:1px">
                                ...
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${receivableList[0].orderAmount}" pattern="##0.##" maxFractionDigits="2"/>" name="receivableList[0].orderAmount"/></td>
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${receivableList[0].orderUnitPrice}" pattern="##0.##" maxFractionDigits="2"/>" name="receivableList[0].orderUnitPrice"/></td>
                                <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" value="${receivableList[0].orderNumber}" name="receivableList[0].orderNumber"/></td>
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${receivableList[0].amountsReceivableMoney}" pattern="##0.##" maxFractionDigits="2"/>" name="receivableList[0].amountsReceivableMoney"/></td>
                                ...
                                <td><input type="hidden" <c:if test="${operType ne 'query' }">value="2"</c:if><c:if test="${operType eq 'query' }">value="${receivableList[0].isUse}"</c:if> name="receivableList[0].isUse"/>
                            ...
                            <c:if test="${operType ne 'insert' }">
                                <c:forEach items="${receivableList}" begin="1" varStatus="index" var="obj">
                                    <tr class="addReceivable">
                                        ...
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.orderAmount }" pattern="##0.##" maxFractionDigits="2"/>" name="receivableList[${index.count }].orderAmount"/></td>
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.orderUnitPrice }" pattern="##0.##" maxFractionDigits="2"/>" name="receivableList[${index.count }].orderUnitPrice"/></td>
                                        <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" value="${obj.orderNumber }" name="receivableList[${index.count }].orderNumber"/></td>
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.amountsReceivableMoney }" pattern="##0.##" maxFractionDigits="2"/>" name="receivableList[${index.count }].amountsReceivableMoney"/></td>
                    ...
                    <div class="scrollbox">
                        <table id="repayableTb">
                            ...
                            <tr class="addRepayable">
                                ...
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${repayableList[0].orderAmount}" pattern="##0.##" maxFractionDigits="2"/>" name="repayableList[0].orderAmount"/></td>
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${repayableList[0].orderUnitPrice}" pattern="##0.##" maxFractionDigits="2"/>" name="repayableList[0].orderUnitPrice"/></td>
                                <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" value="${repayableList[0].orderNumber}" name="repayableList[0].orderNumber"/></td>
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${repayableList[0].amountsPayableMoney}" pattern="##0.##" maxFractionDigits="2"/>" name="repayableList[0].amountsPayableMoney"/></td>
                                ...
                                <td><input type="hidden" <c:if test="${operType ne 'query' }">value="2"</c:if><c:if test="${operType eq 'query' }">value="${repayableList[0].isUse}"</c:if> name="repayableList[0].isUse"/>
                                    <input class="tdinput" type="text" readonly
                            ...
                            <c:if test="${operType ne 'insert' }">
                                <c:forEach items="${repayableList}" begin="1" varStatus="index" var="obj">
                                    <tr class="addRepayable">
                                        ...
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.orderAmount }" pattern="##0.##" maxFractionDigits="2"/>" name="repayableList[${index.count }].orderAmount"/></td>
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.orderUnitPrice }" pattern="##0.##" maxFractionDigits="2"/>" name="repayableList[${index.count }].orderUnitPrice"/></td>
                                        <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" value="${obj.orderNumber }" name="repayableList[${index.count }].orderNumber"/></td>
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.amountsPayableMoney }" pattern="##0.##" maxFractionDigits="2"/>" name="repayableList[${index.count }].amountsPayableMoney"/></td>
                    ...
                    <div class="scrollbox">
                        <table id="billTb">
                            ...
                            <tr class="addBill">
                                ...
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${billList[0].orderAmount}" pattern="##0.##" maxFractionDigits="2"/>" name="billList[0].orderAmount"/></td>
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${billList[0].orderUnitPrice}" pattern="##0.##" maxFractionDigits="2"/>" name="billList[0].orderUnitPrice"/></td>
                                <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" value="${billList[0].orderNumber}" name="billList[0].orderNumber"/></td>
                                <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${billList[0].billAmount}" pattern="##0.##" maxFractionDigits="2"/>" name="billList[0].billAmount"/></td>
                                ...
                                <td><input type="hidden" <c:if test="${operType ne 'query' }">value="2"</c:if><c:if test="${operType eq 'query' }">value="${billList[0].isUse}"</c:if> name="billList[0].isUse"/>
                                    <input class="tdinput" type="text" readonly
                            ...
                            <c:if test="${operType ne 'insert' }">
                                <c:forEach items="${billList}" begin="1" varStatus="index" var="obj">
                                    <tr class="addBill">
                                        ...
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.orderAmount }" pattern="##0.##" maxFractionDigits="2"/>" name="billList[${index.count }].orderAmount"/></td>
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.orderUnitPrice }" pattern="##0.##" maxFractionDigits="2"/>" name="billList[${index.count }].orderUnitPrice"/></td>
                                        <td><input class="tdinput validate[maxSize[11],custom[integer],min[0]]" type="text" value="${obj.orderNumber }" name="billList[${index.count }].orderNumber"/></td>
                                        <td><input class="tdinput validate[maxSize[20],custom[number],min[0]]" type="text" value="<fmt:formatNumber value="${obj.billAmount }" pattern="##0.##" maxFractionDigits="2"/>" name="billList[${index.count }].billAmount"/></td>
                ...
                <div class="tabD">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200"><a href="${file12.url }" title="${file12.oldName }" target="_blank" download="${file12.oldName }" id="file12_a">${file12.oldName }</a></td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file13.url }" title="${file13.oldName }" target="_blank" download="${file13.oldName }" id="file13_a">${file13.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file14.url }" title="${file14.oldName }" target="_blank" download="${file14.oldName }" id="file14_a">${file14.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file15.url }" title="${file15.oldName }" target="_blank" download="${file15.oldName }" id="file15_a">${file15.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file16.url }" title="${file16.oldName }" target="_blank" download="${file16.oldName }" id="file16_a">${file16.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file17.url }" title="${file17.oldName }" target="_blank" download="${file17.oldName }" id="file17_a">${file17.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file18.url }" title="${file18.oldName }" target="_blank" download="${file18.oldName }" id="file18_a">${file18.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file21.url }" title="${file21.oldName }" target="_blank" download="${file21.oldName }" id="file21_a">${file21.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file22.url }" title="${file22.oldName }" target="_blank" download="${file22.oldName }" id="file22_a">${file22.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file23.url }" title="${file23.oldName }" target="_blank" download="${file23.oldName }" id="file23_a">${file23.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file11.url }" title="${file11.oldName }" target="_blank" download="${file11.oldName }" id="file11_a">${file11.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file55.url }" title="${file55.oldName }" target="_blank" download="${file55.oldName }" id="file55_a">${file55.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file56.url }" title="${file56.oldName }" target="_blank" download="${file56.oldName }" id="file56_a">${file56.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file19.url }" title="${file19.oldName }" target="_blank" download="${file19.oldName }" id="file19_a">${file19.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file20.url }" title="${file20.oldName }" target="_blank" download="${file20.oldName }" id="file20_a">${file20.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file24.url }" title="${file24.oldName }" target="_blank" download="${file24.oldName }" id="file24_a">${file24.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file25.url }" title="${file25.oldName }" target="_blank" download="${file25.oldName }" id="file25_a">${file25.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file26.url }" title="${file26.oldName }" target="_blank" download="${file26.oldName }" id="file26_a">${file26.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file27.url }" title="${file27.oldName }" target="_blank" download="${file27.oldName }" id="file27_a">${file27.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file28.url }" title="${file28.oldName }" target="_blank" download="${file28.oldName }" id="file28_a">${file28.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file29.url }" title="${file29.oldName }" target="_blank" download="${file29.oldName }" id="file29_a">${file29.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file30.url }" title="${file30.oldName }" target="_blank" download="${file30.oldName }" id="file30_a">${file30.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file31.url }" title="${file31.oldName }" target="_blank" download="${file31.oldName }" id="file31_a">${file31.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file32.url }" title="${file32.oldName }" target="_blank" download="${file32.oldName }" id="file32_a">${file32.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                        ...
                        <tr>
                            ...
                            <td class="maxwidth200">原件、复印件、加盖公章、提供扫描件</td>
                            <td class="maxwidth200"><a href="${file33.url }" title="${file33.oldName }" target="_blank" download="${file33.oldName }" id="file33_a">${file33.oldName }</a></td>
                            <c:if test="${operType ne 'query' }"><td>
                ...
                <div class="pd20">
                    ...
                    <div class="tabD">
                        <table id="fileTb">
                            ...
                            <tr class="addFile">
                                <td>1</td>
                                <td class="maxwidth200"><a href="${rejectList[0].url }" title="${rejectList[0].oldName }" target="_blank" download="${rejectList[0].oldName }" id="reject0_a">${rejectList[0].oldName }</a></td>
                            ...
                            <c:forEach items="${rejectList}" begin="1" varStatus="index" var="obj">
                                <tr class="addFile">
                                    ...
                                    <td class="maxwidth200"><a href="${obj.url }" title="${obj.oldName }" download="${obj.oldName }" target="_blank"  id="reject${index.count }_a">${obj.oldName }</a></td>
        ...
        <!-- 文件上传form-->
        <iframe id="common_iframe_reject" name="common_iframe_reject" style="display:none;"></iframe>
        <form style="display:none;" id="common_upload_reject_form" enctype="multipart/form-data" method="post" target="common_iframe_reject">
            <input id="common_upload_reject_btn" type="file" name="file" style="display:none;" />
        </form>
        ...
        <script>
                        ...
                        if (data.responseType == "SUCCESS") {
                            ...
                            if (list.length > 0) {
                                ...
                                for (var i in list) {
                                    ...
                                    html += "<td><input class='tdinput' type='text' readonly value="+parseFloat(stockObj.investment_amount.toFixed(2))+" /></td>";
                                    html += "<td><input class='tdinput' type='text' readonly value="+parseFloat(stockObj.received_amount.toFixed(2))+" /></td>";
                    ...
                    $.ajax({
                        ...
                        success:function(data,status){
                            if (data.responseType == "SUCCESS") {
                                ...
                                $("#registerCapital").val(parseFloat(data.object.register_capital.toFixed(2)));
                                $("#paidCapital").val(parseFloat(data.object.paid_capital.toFixed(2)));
                                ...
                                if (data.object.controller_gender == 1) {
                                    $("#controllerGender").val("男");
                                } else if (data.object.controller_gender == 2) {
                                    $("#controllerGender").val("女");
                                }
                                ...
                                if (data.object.legal_gender == 1) {
                                    $("#legalGender").val("男");
                                } else if (data.object.legal_gender == 2) {
                                    $("#legalGender").val("女");
                                }
                    ...
                    $.ajax({
                        ...
                        success:function(data,status){
                            if (data.responseType == "SUCCESS") {
                                ...
                                $("#totalAssetsNewest").val(parseFloat(data.object.total_assets_newest.toFixed(2)));
                                $("#totalAssetsN1").val(parseFloat(data.object.total_assets_n1.toFixed(2)));
                                $("#totalAssetsN2").val(parseFloat(data.object.total_assets_n2.toFixed(2)));
                                $("#totalDebtsNewest").val(parseFloat(data.object.total_debts_newest.toFixed(2)));
                                $("#totalDebtsN1").val(parseFloat(data.object.total_debts_n1.toFixed(2)));
                                $("#totalDebtsN2").val(parseFloat(data.object.total_debts_n2.toFixed(2)));
                                $("#ownerEquityNewest").val(parseFloat(data.object.owner_equity_newest.toFixed(2)));
                                $("#ownerEquityN1").val(parseFloat(data.object.owner_equity_n1.toFixed(2)));
                                $("#ownerEquityN2").val(parseFloat(data.object.owner_equity_n2.toFixed(2)));
                                $("#businessIncomeNewest").val(parseFloat(data.object.business_income_newest.toFixed(2)));
                                $("#businessIncomeN1").val(parseFloat(data.object.business_income_n1.toFixed(2)));
                                $("#businessIncomeN2").val(parseFloat(data.object.business_income_n2.toFixed(2)));
                                $("#businessCostNewest").val(parseFloat(data.object.business_cost_newest.toFixed(2)));
                                $("#businessCostN1").val(parseFloat(data.object.business_cost_n1.toFixed(2)));
                                $("#businessCostN2").val(parseFloat(data.object.business_cost_n2.toFixed(2)));
                                $("#businessProfitNewest").val(parseFloat(data.object.business_profit_newest.toFixed(2)));
                                $("#businessProfitN1").val(parseFloat(data.object.business_profit_n1.toFixed(2)));
                                $("#businessProfitN2").val(parseFloat(data.object.business_profit_n2.toFixed(2)));
                                $("#profitAmountNewest").val(parseFloat(data.object.profit_amount_newest.toFixed(2)));
                                $("#profitAmountN1").val(parseFloat(data.object.profit_amount_n1.toFixed(2)));
                                $("#profitAmountN2").val(parseFloat(data.object.profit_amount_n2.toFixed(2)));
                                $("#netProfitNewest").val(parseFloat(data.object.net_profit_newest.toFixed(2)));
                                $("#netProfitN1").val(parseFloat(data.object.net_profit_n1.toFixed(2)));
                                $("#netProfitN2").val(parseFloat(data.object.net_profit_n2.toFixed(2)));
                                $("#cashFlowNewest").val(parseFloat(data.object.cash_flow_newest.toFixed(2)));
                                $("#cashFlowN1").val(parseFloat(data.object.cash_flow_n1.toFixed(2)));
                                $("#cashFlowN2").val(parseFloat(data.object.cash_flow_n2.toFixed(2)));
                            } else {
                                alert("加载申请人财务情况错误");
                            }
                        },
                            ...
                            if (data.responseType == "SUCCESS") {
                                ...
                                if (enterpriseLoanList.length > 0) {
                                    ...
                                    for (var i in enterpriseLoanList) {
                                        ...
                                        html += "<td><input class='tdinput validate[maxSize[20],custom[number],min[0]]' type='text' value='"+parseFloat(enterpriseLoan.loan_amount.toFixed(2))+"' name='enterpriseLoanList["+i+"].loanAmount'/></td>";
                                        html += "<td><input class='tdinput validate[maxSize[11],custom[integer],min[0]]' type='text' value='"+enterpriseLoan.term+"' name='enterpriseLoanList["+i+"].term'/></td>";
                                        ...
                                        html += "<td><input class='tdinput validate[maxSize[20],custom[number],min[0]]' type='text' value='"+parseFloat(enterpriseLoan.balance.toFixed(2))+"' name='enterpriseLoanList["+i+"].balance'/></td>";
                                ...
                                if (personDebtList.length > 0) {
                                    ...
                                    for (var i in personDebtList) {
                                        ...
                                        html += "<td><input class='tdinput validate[maxSize[20],custom[number],min[0]]' type='text' value='"+parseFloat(personDebt.loan_amount.toFixed(2))+"' name='personDebtList["+i+"].loanAmount'/></td>";
                                        html += "<td><input class='tdinput validate[maxSize[11],custom[integer],min[0]]' type='text' value='"+personDebt.term+"' name='personDebtList["+i+"].term'/></td>";
                                        ...
                                        html += "<td><input class='tdinput validate[maxSize[20],custom[number],min[0]]' type='text' value='"+parseFloat(personDebt.balance.toFixed(2))+"' name='personDebtList["+i+"].balance'/></td>";
                            ...
                            if (data.responseType == "SUCCESS") {
                                ...
                                if (externalGuaranteeList.length > 0) {
                                    ...
                                    for (var i in externalGuaranteeList) {
                                        ...
                                        html += "<td><input class='tdinput validate[maxSize[20],custom[number],min[0]]' type='text' value='"+parseFloat(externalGuarantee.guarantee_amount.toFixed(2))+"' name='guaranteeList["+i+"].guaranteeAmount'/></td>";
                                        html += "<td><input class='tdinput validate[maxSize[11],custom[integer],min[0]]' type='text' value='"+externalGuarantee.term+"' name='guaranteeList["+i+"].term'/></td>";
                                        ...
                                        html += "<td><input class='tdinput validate[maxSize[20],custom[number],min[0]]' type='text' value='"+parseFloat(externalGuarantee.balance.toFixed(2))+"' name='guaranteeList["+i+"].balance'/></td>";
            ...
            // 保存
            function submitFinancing(status) {
            	$(".btn-submit").hide();
            	$(".submiting").show();// 校验表单
            	...
            	if (status == 2) {
                    // 手动校验部分填写
                    // 校验融资方式
                    var financingModeVal = $("#financingMode").find('option:selected').attr('value');
                    if (financingModeVal == 1) {
                        var investorName = $("#investorName").val();
                        if (null == investorName || investorName == '') {
                            alert("融资方式为签约资方时,需要选择最少一个资金方进行融资");
                            $(".btn-submit").show();
                            $(".submiting").hide();
                            return;
                        }
                    } else if (financingModeVal == 3) {
                        var bidExpireDate = $("#bidExpireDate").val();
                        if (null == bidExpireDate || bidExpireDate == '') {
                            alert("融资方式为签约资方时,竞标截止时间不能为空且不能小于当前日期");
                            $(".btn-submit").show();
                            $(".submiting").hide();
                            return;
                        }
                    ...
                    // 校验必上传文件
                    var file_check_11 = $("#file_check_11").val();
                    if (null == file_check_11 || file_check_11 == '') {
                       alert("融资申请表文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_55 = $("#file_check_55").val();
                    if (null == file_check_55 || file_check_55 == '') {
                       alert("应收账款总账及明细账文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_20 = $("#file_check_20").val();
                    if (null == file_check_20 || file_check_20 == '') {
                       alert("租赁合同及近三个月缴费单据未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_24 = $("#file_check_24").val();
                    if (null == file_check_24 || file_check_24 == '') {
                       alert("最近三年经审计的财务报告及最近六个月财务报表文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_27 = $("#file_check_27").val();
                    if (null == file_check_27 || file_check_27 == '') {
                       alert("近一年的银行账户流水文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_28 = $("#file_check_28").val();
                    if (null == file_check_28 || file_check_28 == '') {
                       alert("近六个月的增值纳税申报表文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_29 = $("#file_check_29").val();
                    if (null == file_check_29 || file_check_29 == '') {
                       alert("购销合同文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_30 = $("#file_check_30").val();
                    if (null == file_check_30 || file_check_30 == '') {
                       alert("销售发票(含清单)文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                    var file_check_31 = $("#file_check_31").val();
                    if (null == file_check_31 || file_check_31 == '') {
                       alert("采购订单、出入库清单、库存清单文件未上传");
                       $(".btn-submit").show();
                       $(".submiting").hide();
                       return;
                    }
                ...
                var subid = $("#subid").val();
                if (subid != '' && subid != '0') { 
                    var valStatus = $("#financing_status").val();
                    if (valStatus == 10) {
                        if (status == 1) {
                            status = valStatus;
                        } else {
                    ...
                    $("#financing_status").val(status);
                } else {
                    var valStatus = $("#financingStatus").val();
                    if (valStatus == 11) {
                        if (status == 1) {
                            status = valStatus;
                        }
                    }
                    $("#financingStatus").val(status);
                }
                var financingMode = $("#financingMode").val();
                if (financingMode == 1) {
                    var investorName = $("#investorName").val();
                    var investorList = investorName.split(",");
                    if (investorList.length > 10) {
                        alert("融资方式为签约资方时,最多只能选择10个资金方进行融资");
                        $(".btn-submit").show();
                        $(".submiting").hide();
                        return;
                    }
                ...
                $.ajax({
                    url:"/financingApplyV4Controller/financingApply/saveAll",
                    data:$("form").serialize(),
                    dataType:"json",
                    type:"post",
                ...
                callback = function() {
                    ...
                    if (factoringMode == 1) {
                        url = "/financingApplyV4Controller/financingApply/outList.htm";
                    } else if (factoringMode == 2) {
                        url = "/financingApplyV4Controller/financingApply/darkList.htm";
                    }
                    httpPost(url, param);
                };
            }
            ...
            // 企业借款增加行
            function enterprsieLoanAdd(){
                var enterpriseLoanTb_length = $("#enterpriseLoanTb").find(".enterpriseLoanTr").length;
                var enterpriseLoanTb_tr = $("#enterpriseLoanTb").find("tr").length;
                var td1 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20],custom[number],min[0]]' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].loanAmount'/>"+"</td>");
                var td2 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[11],custom[integer],min[0]]' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].term'/>"+"</td>");
                var td3 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20]]' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].creditor'/>"+"</td>");
                var td4 = $("<td>"+"<input type='text' class='tdinput selectDate' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].loanDate'/>"+"</td>");
                var td5 = $("<td>"+"<input type='text' class='tdinput selectDate' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].expireDate'/>"+"</td>");
                var td6 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20],custom[number],min[0]]' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].balance'/>"+"</td>");
                var td7 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20]]' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].remark'/>"+"</td>");
                var td8 = $("<td>"+"<a class='btn-modify' onclick='enterpriseLoanDeleteRow(this,null)'>删除</a><input type='hidden' name='enterpriseLoanList["+(enterpriseLoanTb_tr - enterpriseLoanTb_length)+"].type' value='1'/>"+"</td>");
                var tr = $("<tr class='addEnterpriseLoan'></tr>");
                tr.append(td1);
                tr.append(td2);
                tr.append(td3);
                tr.append(td4);
            ...
            // 企业借款删除行 
            function enterpriseLoanDeleteRow(obj,id){
                $(obj).parent().parent().remove();
                if(id){
                    var enterpriseLoanId = $("#deleteEnterpriseLoanIdArray").val();
                    enterpriseLoanId +=  id + "#";
                    $("#deleteEnterpriseLoanIdArray").val(enterpriseLoanId);
                }
                 
                // 循环tr
                $("#enterpriseLoanTb").find(".addEnterpriseLoan").each(function(i,item){
                    //循环td
            ...
            // 个人负债增加行
            function personDebtAdd(){
                var personDebtTb_length = $("#personDebtTb").find(".personDebtTr").length;
                var personDebtTb_tr = $("#personDebtTb").find("tr").length;
                
                var td1 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20],custom[number],min[0]]' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].loanAmount'/>"+"</td>");
                var td2 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[11],custom[integer],min[0]]' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].term'/>"+"</td>");
                var td3 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20]]' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].creditor'/>"+"</td>");
                var td4 = $("<td>"+"<input type='text' class='tdinput selectDate' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].loanDate'/>"+"</td>");
                var td5 = $("<td>"+"<input type='text' class='tdinput selectDate' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].expireDate'/>"+"</td>");
                var td6 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20],custom[number],min[0]]' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].balance'/>"+"</td>");
                var td7 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20]]' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].remark'/>"+"</td>");
                var td8 = $("<td>"+"<a class='btn-modify' onclick='personDebtDeleteRow(this,null)'>删除</a><input type='hidden' name='personDebtList["+(personDebtTb_tr - personDebtTb_length)+"].type' value='2'/>"+"</td>");
                var tr = $("<tr class='addPersonDebt'></tr>");
                tr.append(td1);
                tr.append(td2);
                tr.append(td3);
                tr.append(td4);
            ...
            // 个人负债删除行 
            function personDebtDeleteRow(obj,id){
                $(obj).parent().parent().remove();
                if(id){
                    var personDebtId = $("#deletePersonDebtIdArray").val();
                    personDebtId +=  id + "#";
                    $("#deletePersonDebtIdArray").val(personDebtId);
                }
                 
                // 循环tr
                $("#personDebtTb").find(".addPersonDebt").each(function(i,item){
                    //循环td
                    $(item).find("input").each(function(){
                        var name=$(this).attr("name");
                        var first=name.indexOf("[");
            ...
            function guaranteeAdd(){
                var guaranteeTb_length = $("#guaranteeTb").find(".guaranteeTr").length;
                var guaranteeTb_tr = $("#guaranteeTb").find("tr").length;
                
                var td1 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20],custom[number],min[0]]' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].guaranteeAmount'/>"+"</td>");
                var td2 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[11],custom[integer],min[0]]' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].term'/>"+"</td>");
                var td3 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20]]' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].guarantor'/>"+"</td>");
                var td4 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[10]]' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].guaranteeMode'/>"+"</td>");
                var td5 = $("<td>"+"<input type='text' class='tdinput selectDate' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].expireDate'/>"+"</td>");
                var td6 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20],custom[number],min[0]]' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].balance'/>"+"</td>");
                var td7 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[20]]' name='guaranteeList["+(guaranteeTb_tr - guaranteeTb_length)+"].remark'/>"+"</td>");
                var td8 = $("<td>"+"<a class='btn-modify' onclick='guaranteeDeleteRow(this,null)'>删除</a></td>");
                var tr = $("<tr class='addGuarantee'></tr>");
                tr.append(td1);
                tr.append(td2);
                tr.append(td3);
                tr.append(td4);
            ...
            // 对外担保删除行 
            function guaranteeDeleteRow(obj,id){
                $(obj).parent().parent().remove();
                if(id){
                    var guaranteeId = $("#deleteGuaranteeIdArray").val();
                    guaranteeId +=  id + "#";
                    $("#deleteGuaranteeIdArray").val(guaranteeId);
                }
                 
                // 循环tr
                $("#guaranteeTb").find(".addGuarantee").each(function(i,item){
                    //循环td
                    $(item).find("input").each(function(){
                        var name=$(this).attr("name");
                        var first=name.indexOf("[");
            ...
            function receivableAdd(){
                ...
                var td2 = $("<td>"+"<div class='nice-select'><input type='text' class='tdinput select-enterprise validate[maxSize[20]]' oninput='searchList(this.value)' name='receivableList["+(receivableTb_tr - receivableTb_length)+"].customerName'/>"+allEnterpriseStr+"</div>"+"</td>");
                ...
                var td6 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[11],custom[integer],min[0]]' name='receivableList["+(receivableTb_tr - receivableTb_length)+"].orderNumber'/>"+"</td>");
                ...
                var td11 = $("<td>"+"<input type='hidden' value='2' name='receivableList["+(receivableTb_tr - receivableTb_length)+"].isUse'/>"+"</td>");
                var td12 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[120]]' name='receivableList["+(receivableTb_tr - receivableTb_length)+"].remark'/>"+"</td>");
                var td13 = $("<td>"+"<a class='btn-modify' onclick='receivableDeleteRow(this,null)'>删除</a></td>");
            ...
            function repayableAdd(){
                ...
                var td2 = $("<td>"+"<div class='nice-select'><input type='text' class='tdinput select-enterprise validate[maxSize[20]]' oninput='searchList(this.value)' name='repayableList["+(repayableTb_tr - repayableTb_length)+"].supplierName'/>"+allEnterpriseStr+"</div>"+"</td>");
                ...
                var td6 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[11],custom[integer],min[0]]' name='repayableList["+(repayableTb_tr - repayableTb_length)+"].orderNumber'/>"+"</td>");
                ...
                var td11 = $("<td>"+"<input type='hidden' value='2' name='repayableList["+(repayableTb_tr - repayableTb_length)+"].isUse'/>"+"</td>");
                var td12 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[120]]' name='repayableList["+(repayableTb_tr - repayableTb_length)+"].remark'/>"+"</td>");
                var td13 = $("<td>"+"<a class='btn-modify' onclick='repayableDeleteRow(this,null })'>删除</a></td>");
            ...
            function billAdd(){
                ...
                var td2 = $("<td>"+"<div class='nice-select'><input type='text' class='tdinput select-enterprise validate[maxSize[20]]' oninput='searchList(this.value)' name='billList["+(billTb_tr - billTb_length)+"].acceptorName'/>"+allEnterpriseStr+"</div>"+"</td>");
                ...
                var td7 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[11],custom[integer],min[0]]' name='billList["+(billTb_tr - billTb_length)+"].orderNumber'/>"+"</td>");
                ...
                var td13 = $("<td>"+"<input type='hidden' value='2' name='billList["+(billTb_tr - billTb_length)+"].isUse'/>"+"</td>");
                var td14 = $("<td>"+"<input type='text' class='tdinput validate[maxSize[120]]' name='billList["+(billTb_tr - billTb_length)+"].remark'/>"+"</td>");
                var td15 = $("<td>"+"<a class='btn-modify' onclick='billDeleteRow(this,null)'>删除</a></td>");
            ...
            uploadCallback = function(obj) {
                ...
                $("#" + id +"_a").attr('target','_blank');//展示文件名
                var htmlArray = [];
                htmlArray.push("<input type='hidden' value='" + attachment.url_ + "' id='file_check_"+utype+"' name='dataAttachmentList[" + uindex + "].url'/>");
                htmlArray.push("<input type='hidden' value='" + utype+ "' name='dataAttachmentList[" + uindex + "].type'/>");
                ...
                htmlArray.push("<input type='hidden' value='12' name='dataAttachmentList[" + uindex + "].category'/>");
            ...
            $("#addFactory").click(function(){
                var investorName = $("#investorName").val();
                dialog.open('/financingApplyV4Controller/financingApply/selectFactory.htm?investorName='+investorName,'800px','500px','factoryMsg','选择资金方');
                close('outClose');
            });
            ...
            // 补充资料增加行
            function fileAdd(){
                var fileTb_length = $("#fileTb").find(".fileTr").length;
                var fileTb_tr = $("#fileTb").find("tr").length;
                var td1 = "<td>"+(fileTb_tr - fileTb_length + 1)+"</td>";
                var td2 = "<td class='maxwidth200'><a href='' download='' id='reject"+(fileTb_tr - fileTb_length)+"_a'></a></td>";                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
                var td3 = "<td class='maxwidth200'><input type='text' class='tdinput' name='rejectList["+(fileTb_tr - fileTb_length)+"].remark'/></td>";
                var td4 = "<td><a href='javascript:;' class='btn-modify upload-file-reject' id='reject"+(fileTb_tr - fileTb_length)+"' uindex='"+(fileTb_tr - fileTb_length)+"' utype='34'>上传</a>";
                var td5 = "<a href='javascript:;' class='btn-modify delete-one' onclick='fileDeleteRow(this,null)'>删除</a>";
                var td6 = "<div id='reject"+(fileTb_tr - fileTb_length)+"_div' >";
                var td7 = "<input type='hidden' name='rejectList["+(fileTb_tr - fileTb_length)+"].url'/>";
                var td8 = "<input type='hidden' name='rejectList["+(fileTb_tr - fileTb_length)+"].type' value='34'/>";
                var td9 = "<input type='hidden' name='rejectList["+(fileTb_tr - fileTb_length)+"].oldName'/>";
                var td10 = "<input type='hidden' name='rejectList["+(fileTb_tr - fileTb_length)+"].newName'/>";
                var td11 = "<input type='hidden' name='rejectList["+(fileTb_tr - fileTb_length)+"].extName'/>";
                var td12 = "<input type='hidden' name='rejectList["+(fileTb_tr - fileTb_length)+"].fileSize'/>";
                var td13 = "<input type='hidden' value='12' name='rejectList["+(fileTb_tr - fileTb_length)+"].category'/>";
                var td14 = "</div></td>";
                var tr = "<tr class='addFile'>";
                tr =  tr + td1;
                tr =  tr + td2;
                tr =  tr + td3;
                tr =  tr + td4;
            ...
            // 补充资料删除行 
            function fileDeleteRow(obj,id){
                $(obj).parent().parent().remove();
                if(id){
                    var fileId = $("#fileIdArray").val();
                    fileId +=  id + "#";
                    $("#fileIdArray").val(fileId);
                }
                 
                // 序号排序 
                $("#fileTb").find("tr").each(function(i){
            ...
            function rejectActive(){
                 ...
                 */
                // 监听上传按钮
                $("#common_upload_reject_btn").watchProperty("value",function() {
                    var v = $(this).val();
                    if (v == '' || v == null)
                        return;
                    // 上传
                    $("#common_upload_reject_form").attr("action","/fileUploadController/uploadFtp?uploadUrl=/customer/&_callback=uploadRejectCallback");
                    $("#common_upload_reject_form").submit();
                    $(this).val('');
                });
                
                // 点击上传 
                $(".upload-file-reject").click(function() {
                    rejectid = $(this).attr("id");
                    uindex = $(this).attr("uindex");
                    $("#common_upload_reject_btn").click();
                });
                // 回调
                uploadRejectCallback = function(obj) {
                    var attachment = eval('(' + obj + ')');
                    $("#common_upload_reject_btn").val('');
                    $("#" + rejectid +"_a").html(attachment.old_name);//只允许一行一个附件
                    $("#" + rejectid +"_a").attr('href',attachment.url_);//供下载
                    $("#" + rejectid +"_a").attr('download',attachment.old_name);//供下载
                    $("#" + rejectid +"_a").attr('title',attachment.old_name);//展示名字
                    $("#" + rejectid +"_a").attr('target','_blank');//展示名字
                    var htmlArray = [];
                    htmlArray.push("<input type='hidden' value='" + attachment.url_ + "' name='rejectList[" + uindex + "].url'/>");
                    htmlArray.push("<input type='hidden' value='34' name='rejectList[" + uindex + "].type'/>");
                    htmlArray.push("<input type='hidden' value='" + attachment.old_name + "' name='rejectList[" + uindex + "].oldName'/>");
                    htmlArray.push("<input type='hidden' value='" + attachment.new_name + "' name='rejectList[" + uindex + "].newName'/>");
                    htmlArray.push("<input type='hidden' value='" + attachment.ext_name + "' name='rejectList[" + uindex + "].extName'/>");
                    htmlArray.push("<input type='hidden' value='" + attachment.file_size + "' name='rejectList[" + uindex + "].fileSize'/>");
                    htmlArray.push("<input type='hidden' value='12' name='rejectList[" + uindex + "].category'/>");
                    $("#" + rejectid + "_div").empty().html(htmlArray.join(""));//只允许一行一个附件
                }
            }
            rejectActive();
        </script>
