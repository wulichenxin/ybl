...
<html>
	...
	<form action="/contractController/list.htm" id="pageForm" method="post">
		<div class="w1200 ybl-info">
			...
			<div class="ground-form mb20">
				...
				<div class="form-grou mr20"><label class="label-long">融资订单号：</label><input class="content-form" name="financing_order_number"  value="${financinapply.financing_order_number}" /></div>
				...
				<div class="scrollbox">
					<table>
						...
						<tr>
							...
							<td><a href="javascript:;" class="order-a viewContract" pid="${entity.id}" uid="${entity.master_contract_no}">${entity.financing_order_number}</a></td>
							...
							<td><a href="javascript:;" class="btn-modify mr10  viewContract" pid="${entity.id}" uid="${entity.master_contract_no}">查看</a></td>
						</tr>
					</c:forEach>
		...
		$(".viewContract").click(function() {
			...
			httpPost('/contractController/goInfo.htm',param);
			//window.open('/contractController/goInfo.htm?master_contract_no='+uid+'&id='+pid, '_blank', '');
