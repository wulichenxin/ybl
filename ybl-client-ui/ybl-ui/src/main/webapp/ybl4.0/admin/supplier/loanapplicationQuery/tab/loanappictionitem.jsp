	...
	<div class="w1200">
		...
		<div class="w1200 ybl-info box box1">
			<div class="ground-form mb20">
				<div class="form-grou mr40"><label class="label-long">申请单位：</label><input class="content-form2" name="enterpriseName" value="${resultInfo.enterpriseName}" readonly/></div>
				<div class="form-grou mr40"><label class="label-long">放款申请单号：</label><input class="content-form2" name="orderNo" readonly value="${resultInfo.orderNo} "/></div>
				<div class="form-grou mr40"><label class="label-long">融资主合同号：</label><input class="content-form2" name="masterContractNo" readonly value="${resultInfo.masterContractNo}"/></div>
				
			</div>
			
			<div class="ground-form mb20">
                <div class="form-grou mr40"><label class="label-long">融资订单号：</label><input class="content-form2" name="financingOrderNumber" readonly value="${resultInfo.financingOrderNumber}"/></div>
				<div class="form-grou mr40"><label class="label-long">合同总金额：</label><input class="content-form2" readonly  value="<fmt:formatNumber value="${contracts.newCreditAmount}" pattern="#,##0.##"/>"/><span class="timeimg">元</span></div>
				<div class="form-grou mr40"><label class="label-long">剩余可用余额：</label><input class="content-form2" id="remainBalance" readonly value="<fmt:formatNumber value="${contracts.newCreditAmount}" pattern="#,##0.##"/>"/><span class="timeimg">元</span></div>
			</div>
			...
			<div class="chebox chebox1">
				...
				<div class="grounpinfo">
					<div class="ground-form mb20">
						<div class="form-grou mr40"><label>融资方：</label><input class="content-form" name="financier"  value="${resultInfo.financier}" readonly/></div>
						<div class="form-grou mr40"><label>融资金额：</label><input class="content-form" name="financing_amount" value="<fmt:formatNumber value="${resultInfo.financing_amount}" pattern="#,##0.##"/>"/><span class="timeimg">元</span></div>
                        <div class="form-grou mr40"><label>融资期限：</label><input class="content-form" name="financingTerm"  value="${resultInfo.financingTerm}"/><span class="timeimg">天</span></div>
                        <div class="form-grou"><label>融资利率：</label><input class="content-form" name="financingRate"  value="<fmt:formatNumber value="${resultInfo.financingRate}" pattern="#,##0.####"/>"/><span class="timeimg">%</span></div>
					</div>
				</div>
		...
		<div class="btn2 mt40 clearfix mb80">
					...
					<a href="#" class="btn-add btn-return" style="">返回</a>
				</div>
		</div>
