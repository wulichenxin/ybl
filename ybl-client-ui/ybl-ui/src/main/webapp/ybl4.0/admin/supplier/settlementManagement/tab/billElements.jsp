			...
			<div class="w1200">
				...
				<div class="ground-form mb20">
					...
					<div class="ground-form mb20">
						...
						<div class="form-grou mr50">
							<label>票据持有人：</label>
							<input class="content-form2" name="billHolder" value="${vo.billHolder }"/>
						</div>
						<div class="form-grou">
							<label class="w140">票据承兑人：</label>
							<input class="content-form2" name="billAcceptor" value="${vo.billAcceptor }"/>
						</div>
					</div>
					<div class="ground-form mb20">
						<div class="form-grou mr50">
						...
						<div class="form-grou">
							...
							<input class="content-form2" name="billMoney" value="${vo.billMoney }"/><span class="timeimg">元</span>
						</div>
					</div>
					<div class="ground-form mb20">
						<div class="form-grou mr50">
						...
						<div class="form-grou">
							<label class="w140">逾期利率：</label>
							<input class="content-form2" name="overdueInterestRate" value="${vo.overdueInterestRate }"/><span class="timeimg">%</span>
						</div>
					</div>
					<div class="ground-form mb20">
						<div class="form-grou">
						...
						<div class="form-grou mr50">
							<label class="w140">票据开票日期：</label>
							<input id="beginDate" class="content-form2" name="billingDate" value="${vo.billingDate }"/><img class="timeimg" src="${app.staticResourceUrl}/ybl4.0/resources/images/cal_icon.png" />
						</div>
						<div class="form-grou mr50">
							<div class="form-grou">
							<label class="w140">结算比例：</label>
							<input class="content-form2" name="balanceScale" value="${vo.balanceScale }"/><span class="timeimg">%</span>
							</div>
						</div>
					</div>
					</div>
				...
				<div class="btn3 clearfix mb80">
					...
					<a href="javascript:;" class="btn-add" id="commit">审核</a>
